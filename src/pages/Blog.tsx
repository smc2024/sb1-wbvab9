...
const BlogPost = ({ title, excerpt, image, delay }) => {
  ...
  return (
    <motion.div
      ref={ref}
      className="bg-white bg-opacity-80 backdrop-blur-lg rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow duration-300"
    ...
    >
      ...
      <div className="p-6">
        ...
        <a href="#" className="text-pink-600 hover:text-pink-800 font-medium">Read more</a>
      </div>
    </motion.div>
  );
};
